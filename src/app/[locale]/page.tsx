  ...
  return (
    <div>
      {buildingStep === null && <main className={`md:h-screen overflow-hidden w-full flex flex-col-reverse md:flex-row gap-10 items-center pt-24 md:pt-10 relative`}>
        ...
        <div className="md:pl-36 md:pr-24 flex w-full md:mt-0 md:w-6/12 flex-col justify-center">
      ...
      {buildingStep === null && <div className="mt-48 w-full flex flex-col items-center">
        ...
        <div className="w-8/12 flex flex-col md:flex-row gap-y-16 md:gap-y-10 gap-10 mt-36">
          <div className="w-full md:w-4/12 p-5 bg-background dark:bg-accent/30 shadow-xl rounded-2xl flex flex-col items-center relative">
            ...
            <h2 className="mt-16 font-medium text-xl"><span className="font-extrabold text-4xl mt-1 mr-1">1#</span>{t('roadMapOneTitle')}</h2>
            <p className="text-muted-foreground mt-5">{t('roadMapOneDescription')}</p>
          ...
          <div className="w-full md:w-4/12 p-5 bg-background dark:bg-accent/30 shadow-xl rounded-2xl flex flex-col items-center relative">
            ...
            <h2 className="mt-16 font-medium text-xl"><span className="font-extrabold text-4xl mt-1 mr-1">2#</span> {t('roadMapTwoTitle')} </h2>
            <p className="text-muted-foreground mt-5">{t('roadMapTwoDescription')}</p>
          ...
          <div className="w-full md:w-4/12 p-5 bg-background dark:bg-accent/30 shadow-xl rounded-2xl flex flex-col items-center relative">
            ...
            <h2 className="mt-16 font-medium text-xl"><span className="font-extrabold text-4xl mt-1 mr-1">3#</span>{t('roadMapThreeTitle')} </h2>
            <p className="text-muted-foreground mt-5">{t('roadMapThreeDescription')}</p>
          </div>
        </div>
      </div>}
      ...
      {buildingStep === null && <div className="my-48 w-full flex flex-col items-center">
        ...
        <p className="text-muted-foreground text-center mt-5">{t('services.servicesDescription')}</p>
        ...
        <div className="w-11/12 md:w-10/12 flex flex-col md:flex-row gap-y-20 md:gap-y-10 gap-10 mt-36">
          ...
          <div className="md:w-4/12 p-8 bg-background dark:bg-accent/30 shadow-xl rounded-2xl flex flex-col">
            <h2 className="font-extrabold text-3xl">{t('services.completeRenovation.title')}</h2>
            <p className="text-muted-foreground mt-5">{t('services.completeRenovation.description')}</p>
            <img
          ...
          <div className="md:w-4/12 p-8 scale-110 bg-background dark:bg-accent/30 shadow-xl rounded-2xl flex flex-col">
            <h2 className="font-extrabold text-3xl">{t('services.homeExtensions.title')}</h2>
            <p className="text-muted-foreground mt-5">{t('services.homeExtensions.description')}</p>
            <img
              className="mt-5 min-h-96 rounded-2xl w-full"
          ...
          <div className="md:w-4/12 p-8 bg-background dark:bg-accent/30 shadow-xl rounded-2xl flex flex-col">
            <h2 className="font-extrabold text-3xl">{t('services.craftsmanship.title')}</h2>
            <p className="text-muted-foreground mt-5">{t('services.craftsmanship.description')}</p>
            <img
              className="mt-5 min-h-96 rounded-2xl w-full"
