...
export default function Page() {
    return (
        <div>
            <div className="w-full flex p-32 flex-col items-center">
                <GridPattern
                    width={30}
                    height={30}
                    x={-1}
            ...
            <BlurFade delay={0.25} inView>
                <div className="flex flex-row-reverse w-9/12 mx-auto h-[22em] my-48">
                    <div
                    ...
                    <div className="w-6/12 h-[22em] p-10 border rounded-r-sm rounded-l-3xl bg-background">
                        <h2 className="text-5xl font-bold">Extension Project</h2>
            ...
            <BlurFade delay={0.25} inView>
                <div className="flex w-9/12 mx-auto h-[22em] my-48">
                    <div
                        className="w-6/12 scale-105 z-20">
                        <img
                            className="w-full rounded-l-3xl h-[22em] rounded-r-lg "
                            src={'/renovation-project.avif'}
                            alt={'Rating'}
                        />
                    </div>
                    <div className="w-6/12 h-[22em] p-10 border rounded-l-sm rounded-r-3xl bg-background">
                        <h2 className="text-5xl font-bold">Renovation Project</h2>
                        <p className="mt-10 text-muted-foreground text-lg">
            ...
            <div className="w-full flex p-32 my-20 flex-col items-center">

                <TextAnimate className="text-6xl text-center font-bold" animation="blurInUp" by="character">
                    Projects
                </TextAnimate>
                <p className="text-muted-foreground mt-5">Discover our renovations and extensions for your dream home</p>
                <section id="photos" className="mt-20">
                    <div className="columns-2 gap-4 sm:columns-3">
            ...
            <BlurFade delay={0.25} inView>
                ...
                <p className="text-muted-foreground w-6/12 mx-auto text-center mt-5">Read here the experiences of our satisfied customers about our projects</p>

                <div className="flex w-9/12 mx-auto h-[25em] my-20 mb-48">
                    <div className="w-6/12 h-full p-10  shadow-2xl border rounded-r-sm rounded-l-3xl bg-background">
                        <h2 className="text-2xl font-bold text-primary">★★★★★</h2>
                        <h2 className="text-lg mt-2">Home Renovation: Kitchen, Living Room/Dining Room, Bedroom(s)</h2>
                        <p className="mt-5 text-muted-foreground w-10/12">
                    ...
                    <div className="w-6/12 z-20 h-full p-10 -ml-5 shadow-2xl scale-110 border rounded-l-sm rounded-r-3xl bg-background">
                        ...
                        <div className="flex items-center gap-5 mt-5">
                            <img
                                ...
                                alt={'Rating'}
                            />
                            <p className="text-lg text-muted-foreground ">Fahrhad Sarabi</p>
                        </div>
                    </div>
                ...
                <div className="flex flex-row-reverse w-9/12 mx-auto  my-20 mb-48">
                    <div className="w-6/12 h-full p-10 border rounded-l-sm rounded-r-3xl shadow-2xl pl-20 bg-background">
                        <h2 className="text-2xl font-bold text-primary">★★★★★</h2>
                        <h2 className="text-lg mt-2">Complete renovation including extension and new dormer window</h2>
                        <p className="mt-5 text-muted-foreground w-10/12">
                        ...
                        <div className="flex items-center mt-5 gap-5">
                            <img
                                ...
                                alt={'Rating'}
                            />
                            <p className="text-lg text-muted-foreground ">Remmert family</p>
                        </div>
                    </div>
                    <div className="w-6/12 z-20 h-full p-10 border scale-110 shadow-2xl rounded-r-sm rounded-l-3xl bg-background">
                        <h2 className="text-2xl font-bold text-primary">★★★★★</h2>
                        <h2 className="text-lg mt-2">Renovation of kitchen and hallway</h2>
                        <p className="mt-5 text-muted-foreground w-10/12">
                        ...
                        <div className="flex items-center gap-5 mt-5">
                            <img
                                ...
                                alt={'Rating'}
                            />
                            <p className="text-lg text-muted-foreground ">Jan Floor</p>
                        </div>
                    </div>
